...
import UserParametersForm from "./components/UserParametersForm.jsx";
...
// Iterate through the dates
    ...
    Object.entries(dateData).forEach(([productName, productData]) => {
        ...
        // Iterate over each eBay listing to create an individual card
        Object.entries(ebayListings).forEach(([ebayListingTitle, ebayListingData]) => {
        transformedProducts.push({
            id: `${date}-${productName}-${ebayListingTitle}`,
            title: ebayListingTitle,
            ebay_price: parseFloat(ebayListingData.Price || "0"),
            chinese_price_rmb: parseFloat(goofishData.Price || "0"),
            chinese_price_usd: parseFloat(goofishData.Price || "0") / 7.2, // Convert RMB to USD
            ebay_link: ebayListingData.listing_link || "#",
            china_link: goofishData.listing_link || "#",
            ebayImage: ebayListingData.img_link || "https://via.placeholder.com/150",
            goofishImage: goofishData.img_link || "https://via.placeholder.com/150",
        });
        });
    });
    });
    ...
    Object.entries(rawData).forEach(([date, dateData]) => {
      ...
      Object.entries(dateData).forEach(([productName, productData]) => {
        ...
        transformedProducts.push({
          ...
          china_link: goofishData.listing_link || "#",
          image:
            firstEbayListing.img_link ||
            goofishData.img_link ||
